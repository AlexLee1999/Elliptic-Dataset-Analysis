...
if __name__ == "__main__":
    ...
    clf = RFE(estimator=RandomForestClassifier(n_estimators=50, max_depth=100, random_state=0), n_features_to_select=90, step=1).fit(X_train, Y_train)
